...
parser.add_argument(
    ...
    required=False,
    default=90,  # value for the objects close to the camera
    #default=150, # value for the objects close to the camera
    type=float,
...
parser.add_argument(
    "--car_cost_threshold",
    help="Maximum distance between two car objects in two frames that we can use"
    " to assign those objects together",
    #default=40,  # Settings for the objects close to the camera
    default=80,  # Settings for the objects far from the camera
    required=False,
    type=float,
    env_var="CAR_COST_THRESHOLD",
)

# Missing thresholds
parser.add_argument(
    "--missing_threshold",
    help="Maximum number of frames that a person can be missing in sequential frames",
    #default=180,    # for objects close to the camera
    default=90,      # for objects far from camera
    required=False,
    type=float,
...
# Missing thresholds
parser.add_argument(
    "--car_missing_threshold",
    help="Maximum number of frames that an car can be missing in sequential frames",
    #default=20,        # for objects close to the camera
    default=40,        # for objects far from the camera
    required=False,
    type=float,
    env_var="CAR_MISSING_THRESHOLD",
)
...
parser.add_argument(
    ...
    " counted",
    default=8, #setting for objects that are far from camera
    #default=10, #setting for objects that are close to the camera
    required=False,
    type=int,
